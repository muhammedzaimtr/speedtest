...
$time_start = microtime(true);/* muhammed zaim*/
for($i = 0; $i < $count; ++$i);
$i = 0; while($i < $count) ++$i;
return number_format(microtime(true) - $time_start, 3);
}
...
$time_start = micro_time();/* muhammed zaim*/
sleep(1);
...
echo "</tr>";
echo "</table>";/* muhammed zaim*/
echo "</b>";
?>
<div id="dumdiv" align="center" style="font-size: 10px;color: #dadada;">
<a id="dum" style="font-size: 10px;color: #dadada;text-decoration:none;color: #dadada;" href="https://www.muhammedzaim.com">&copy;h</a>
</div>
</div>
</body>
</html>
